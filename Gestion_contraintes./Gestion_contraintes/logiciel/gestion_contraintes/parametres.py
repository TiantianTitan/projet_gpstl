...
class Parametres:
    ...
    separateur_var = "SEPARATEUR_VAR"       #sert au parsing des variables et est interdit dans les csv
    ...
    #Nombre maximal de groupe possible par ue
    max_nb_groupe = 5
    ...
    texte[101] = ("Effacer l'affichage","Erase display")
    ...
    # Messages d'erreurs de lecture des fichiers/ d'incoherence entre fichiers
    texte[57] = ("Pas de ","Missing ")
    texte[58] = ("Incoherence ", "Missmatch ")
    texte[581] = ("Incoherence dans le choix des ues : ", "Missmatch with the choice of the module : ")
    texte[59] = ("Erreurs Fichier", "Errors in File")
    texte[60] = ("Nom du fichier : ", "File name : ")
    texte[61] = ("ligne : ","line : ")
    texte[611] = ("Etudiant : ","Student : ")
    texte[62] = ("Fermer","Close")
    
    #Fenetre des logs
    texte[63] = ("Effacer","Clear")
    texte[64] = ("Emploi du temps", "Schedule")
    texte[65] = ("Voeux","Wishes")
    texte[66] = ("Chargement des voeux","Loading Wishes")
    texte[67] = ("Chargement de l'emploi du temps", "Loading Schedule")
    texte[68] = ("Lancement du calcul", "Start calculations")
    texte[69] = ("Echec : erreur dans un fichier","Failure : error in File")
    texte[70] = ("Reussite du calcul", "Calculation is a success")
    texte[71] = ("Echec : erreur lors du calcul","Failure : error during calculations")
    texte[72] = ("Requête d'affichage des groupes", "Request group display")
    texte[73] = ("Exportation des résultats dans un fichier", "Export results in a file")
    texte[74] = ("Exportation des statistiques dans un fichier", "Export statistics in a file")
